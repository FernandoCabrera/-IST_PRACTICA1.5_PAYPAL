...
<input type=image src="resources/images/seguir.jpg"/></form>
</h3></form>
...
<input type="hidden" name="business" value="fcc00050-facilitator@red.ujaen.es">
...
<input type=image src="resources/images/cancelar.jpg"/></form>

<!-- Boton que sigue comprando -->
<form action="sigueComprando" method=post>
<input type=image src="resources/images/seguir.jpg" style="float:right;"/></form>
</h3>
